...
class CRLSetPlugin(TrustHubPlugin):
    crlsetFilePath = "C:/tmp/crlset"
    crlsetVersionFilePath = 'C:/tmp/crlset-verison'
    crlsetDumpFilePath = 'C:/tmp/crlset-dump'

    crlsetLogFilePath = 'C:/tmp/crlset.log'
    crlsetCertFilePath = 'C:/tmp/crlset_cert.pem'
    crlsetChainFilePath = 'C:/tmp/crlset_chain.pem'

    crlsetBadCertFilePath = 'C:/tmp/crlset_badCert.pem'

    crlsetLibraryPath = os.path.dirname(os.path.realpath(__file__))+'/crlset.dll'
