...
typedef enum REQUESTED_ACTION { RA_WAIT, RA_CONTINUE, RA_NEED_MORE, RA_NOT_INTERESTED, RA_ERROR } REQUESTED_ACTION;
typedef enum PROCESSING_STATE { PS_UNKNOWN, PS_HANDSHAKE_LAYER, PS_RECORD_LAYER, PS_CERTIFICATE, PS_IRRELEVANT, PS_ERROR } PROCESSING_STATE;
